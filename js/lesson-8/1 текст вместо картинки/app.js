...
function handleClick(clickedButtonEvent) {
	...
	const card = {
		...
		productName: cardNode.querySelector('.product-name'), // здесь .productName, который внутри .product
	...
	let text = card.button.innerHTML;
...
function showMoreText(card) {
	...
	let text = 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit, fuga';
